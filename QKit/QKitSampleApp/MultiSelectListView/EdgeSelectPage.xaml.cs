...
namespace QKitSampleApp.MultiSelectListView
{
    ...
    /// </summary>
    public sealed partial class EdgeSelectPage : Page
    {
        private NavigationHelper navigationHelper;
        private ObservableDictionary defaultViewModel = new ObservableDictionary();

        public EdgeSelectPage()
        {
        ...
        {
            SelectList.SelectionMode = ListViewSelectionMode.Multiple;
        }

        private void OkAppBarButton_Click(object sender, RoutedEventArgs e)
        {
            SelectList.SelectionMode = ListViewSelectionMode.None;
        }

        private void SelectList_SelectionModeChanged(object sender, RoutedEventArgs e)
        {
            if (SelectList.SelectionMode != ListViewSelectionMode.Multiple)
            {
